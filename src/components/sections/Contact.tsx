            ...
            >
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-heading mb-4 md:mb-6 italic text-emerald-primary">
                        Reach Out <span className="gradient-text">in Peace</span>
                    </h2>
                    <div className="h-[0.5px] w-20 md:w-28 bg-emerald-primary/10 mx-auto" />
                </div>

                <div className="max-w-4xl mx-auto text-center px-4">
                    <p className="text-lg md:text-3xl font-heading italic text-text-secondary leading-relaxed mb-8 md:mb-12">
                        "Whether you seek to collaborate, share knowledge, or simply exchange salaam — I welcome your <span className="text-emerald-primary">correspondence</span> with open heart."
                    </p>

                    <div className="mb-12 md:mb-16 bg-bg-secondary/30 backdrop-blur-sm p-8 md:p-12 border border-emerald-primary/10 deckle-edge deckle-top deckle-bottom rounded-sm">
                        <p className="text-base md:text-xl font-heading italic text-emerald-primary leading-relaxed">
                            "Our Lord, accept from us. Indeed You are the Hearing, the Knowing."
                        </p>
                        <p className="text-sm text-gold-accent/70 mt-4 tracking-widest uppercase">
                    ...
                    <div className="flex flex-col items-center gap-20 md:gap-24">
                        ...
                        >
                            ...
                            <MagneticButton
                                ...
                                className="relative w-40 h-40 md:w-56 md:h-56 rounded-full border-2 border-dashed border-gold-accent/30 flex items-center justify-center p-4 bg-bg-secondary/20 backdrop-blur-md group-hover:border-gold-accent group-hover:rotate-6 transition-all duration-1000 shadow-2xl overflow-hidden"
                            >
                        ...
                        <div className="flex flex-col items-center gap-8 pb-12">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] text-gold-accent font-bold">Connect</span>
                                <div className="h-[0.5px] w-8 md:w-16 bg-emerald-primary/10" />
                            </div>
                    ...
                    {/* Decorative Border */}
                    <div className="mt-16">
                        <IslamicBorder variant="geometric" className="w-full max-w-3xl mx-auto" />
                    </div>
                </div>
            </motion.div>
        </section>
